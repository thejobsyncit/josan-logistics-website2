export const initialShipments = [
  {
    ...
    timeline: [
      { title: 'Consignment Booked & Lorry Receipt (LR) Issued', location: 'Jurong Central Highway Depot', timestamp: 'Aug 31, 08:15 AM', completed: true, icon: 'FileCheck' },
      { title: 'Vehicle Loaded & Weighbridge Clearance Passed', location: 'Depot Loading Bay 4', timestamp: 'Aug 31, 10:40 AM', completed: true, icon: 'Truck' },
      { title: 'Highway Transit via PIE Expressway Corridor', location: 'PIE Expressway Telematics Gate', timestamp: 'Aug 31, 01:20 PM', completed: true, current: true, icon: 'PackageCheck' },
      { title: 'Arrived at Woodlands Offloading Bay', location: 'Woodlands North Park Bay 2', timestamp: 'Expected Today, 03:45 PM', completed: false, icon: 'MapPin' },
      { title: 'Final Handover & Digital LR Signature Confirmed', location: 'Woodlands Industrial Depot', timestamp: 'Expected Today, 04:30 PM', completed: false, icon: 'CheckCircle2' },
    ],
